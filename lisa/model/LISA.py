...
class LISAWithDiscriminator(nn.Module):
    ...
    def forward(
        ...
        expert_discriminator_loss = eta * (-(expert_loss_weight).log()).mean()
        nonexpert_discriminator_loss = -(1-nonexpert_loss_weight).log().mean()
        ...
        return {
            'loss': expert_discriminator_loss + nonexpert_discriminator_loss + generator_ce_loss + generator_dice_loss,
            'expert_discriminator_loss':  expert_discriminator_loss.item(),
            'nonexpert_discriminator_loss': nonexpert_discriminator_loss.item(),
            'generator_ce_loss': generator_ce_loss.item(),
            'generator_dice_loss': generator_dice_loss.item(),
